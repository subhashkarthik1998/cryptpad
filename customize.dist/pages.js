define([
    ...
    Pages['/how-to-help.html'] = function () {
        return h('div#cp-main', [
            infopageTopbar(),
            h('div.container-fluid.cp-contdet', [
                ...
                h('div.row.cp-iconCont.align-items-center', [
                        ...
                        h('span.card',
                            h('div.card-body',
                                [
                                    ...
                                    setHTML(h('p'), 'Spread the word: Blog, ' +
                        ...
                        h('span.card',
                            h('div.card-body',
                                [
                                    ...
                                    setHTML(h('p'), 'Announce that you like it! <br>E.g. on <a href="https://alternativeto.net/software/cryptpad/">AlternativeTo</a>:\n' +
                                        '\n' +
                    ...
                    h('div.col-8.col-sm-4.col-md-4.col-lg-4',
                        h('span.card',
                            h('div.card-body',
                                [
                                    setHTML(h('p'), '<img src="/customize/images/dandelion.jpeg" style="width:100%">')
                                ]
                            )
                        )
                    ),
