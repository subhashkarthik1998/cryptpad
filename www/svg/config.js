...
svgEditor.setCustomHandlers({
 save: function(win, data) {
   ...
   console.log(window.parent.APP.config.onLocal());
   window.parent.APP.config.onLocal();
 }
});
...
var once = function (cb) {
    ...
    to = window.setTimeout(cb, 500);
};
svgEditor.addExtension("cryptpad", function(S) {
    return {
        name: 'cryptpad',
        elementChanged : function(opts) {
            console.log("changed");
            once(window.parent.APP.config.onLocal);
        },
